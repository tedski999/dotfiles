...
augroup vimrc
	...
	" <c-space> to open in netrw
	autocmd FileType netrw nmap <buffer> <c-space> <cr>
augroup end
]])
...
-- Settings
vim.api.nvim_set_keymap("n", "<f3>",             "<cmd>set wrap!<cr>",                                                    {})
vim.api.nvim_set_keymap("i", "<f3>",             "<c-o><cmd>set wrap!<cr>",                                               {})
vim.api.nvim_set_keymap("n", "<f4>",             "<cmd>set spell!<cr>",                                                   {})
vim.api.nvim_set_keymap("i", "<f4>",             "<c-o><cmd>set spell!<cr>",                                              {})
vim.api.nvim_set_keymap("n", "<f5>",             "<cmd>set relativenumber!<cr>",                                          {})
vim.api.nvim_set_keymap("i", "<f5>",             "<c-o><cmd>set relativenumber!<cr>",                                     {})
-- Movement
...
vim.api.nvim_set_keymap("v", "<leader>r",        "*:%s///gcI<left><left><left><left>",                                    {})
...
vim.api.nvim_set_keymap("n", "<leader>c",        "<cmd>Telescope find_files cwd="..config_path.."<cr>",                   {})
vim.api.nvim_set_keymap("n", "<leader>t",        "<cmd>TagbarToggle c<cr>",                                               {})
vim.api.nvim_set_keymap("n", "<leader>T",        "<cmd>execute 'Telescope tags ctags_file='.b:gutentags_files.ctags<cr>", {})
-- Debug
...
vim.api.nvim_set_keymap("v", "<leader>di",       "<Plug>VimspectorBalloonEval",                                           {})
vim.api.nvim_set_keymap("n", "<leader>dc",       "<Plug>VimspectorRunToCursor",                                           {})
-- Help
